        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
            ...
            <form action="{{ route('auth.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="{{old('name')}}" name="name" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('name')
                ...
                <div class="mb-4">
                    <label for="profile_picture" class="block text-sm font-medium text-gray-700 mb-2">Photo de profil</label>
                    <input type="file" value="{{old('image')}}" name="image" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('image')
                    <span class="text-red-400">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" value="{{old('cin')}}" name="cin" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('cin')
                    <span class="text-red-400">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" value="{{old('email')}}" name="email" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('email')
                    <span class="text-red-400">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" value="{{old('password')}}" name="password" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    @error('password')
                    <span class="text-red-400">{{$message}}</span>
                    @enderror
                </div>

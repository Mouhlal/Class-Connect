...
<body class="bg-gray-100 text-gray-700">
    ...
    <div class="container md:relative md:bottom-44 mx-auto px-4 py-8">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-green-700">Modifier le Module</h1>
        </div>

        <div class="bg-white shadow-lg rounded-lg p-6 max-w-xl mx-auto">
            <form action="{{ route('modules.edit', $modules->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
